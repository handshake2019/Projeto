...
<head>
    ...
    #opcaogeneromusicaleventos{
        float: left;
        margin-left: 120px;
        width: 300px;
    }
    #opcaolocalizacaoeventos{
        float: left;
        margin-left: 400px;
        width: 300px;
    }
    #opcaodisponibilidadeeventos{
        float: right;
        margin-right: 100px;
        width: 300px;
    }
    ...
    #fotobusca3eventos{
        ...
        background-image: url("img/balada.jpg");
        background-size: cover;
    }
    #fotobusca4eventos{
        float: left;
        ...
        margin-top: 50px;
        border: 1px solid red;
        background-image: url("img/festainfantil.jpg");
        background-size: cover;
    }
    #fotobusca5eventos{
        float: left;
...
<div>
	<h1 id="eventostitulo">Eventos</h1>
</div>
<div>
...
<div>
    <div id="generomusicaleventos" class="opcaoeventos"> <!--Esquerda-->
        <select id="opcaogeneromusicaleventos">
    ...
    <div id="localizacaoeventos" class="opcaoeventos"> <!--Centro-->
        <select id="opcaolocalizacaoeventos">
    ...
    <div id="disponibilidadeeventos" class="opcaoeventos"> <!--Direita-->
        <select id="opcaodisponibilidadeeventos">
...
<div class="fotobusca">
    ...
    <fieldset id="fotobusca1eventos">
        
    </fieldset>
    
    <fieldset id="fotobusca2eventos">
        
    </fieldset>

    <fieldset id="fotobusca3eventos">
...
<div class="fotobusca">
        ...
        <fieldset id="fotobusca4eventos">
            
        </fieldset>
        
        <fieldset id="fotobusca5eventos">
            
        </fieldset>
    
        <fieldset id="fotobusca6eventos">
